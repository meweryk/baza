...
const materialScheme = new Schema({
    _id: {
      type: String,
      //uppercase: true,
      required: [true, 'Укажите наименование материала']
    },
    ni: String,
    cr: String,
    mo: String,
...
mongoose.connect("mongodb+srv://Ivashchenko:i220903110976P%2F%29@cluster0-hc5cb.gcp.mongodb.net/materialsdb?retryWrites=true&w=majority", {useNewUrlParser: true}, function(err){
...
app.post("/api/materials", jsonParser, function (req, res) {
  ...
  const material = new Material({_id: materialVid, ni: materialNi, cr: materialCr, mo: materialMo, cu: materialCu, mn: materialMn, w: materialW, v: materialV, co: materialCo, si: materialSi, ti: materialTi, al: materialAl, nb: materialNb});
